...
import { parseReviewResult } from "../../src/review/agent.js";
import type { ReviewJob } from "../../src/jobs/types.js";
import { readWorkspaceFile, withWorkspace } from "../../src/workspace/workspace.js";
import { validateMemoryReferences } from "../../src/review/review.processor.js";
...
test("模型不能引用未召回或跨仓库 Memory", () => {
  ...
  const result: import("../../src/review/types.js").ReviewResult = { summary: "", coverage: [], limitations: [], findings: [{ category: "team_rule", severity: "medium", evidenceLevel: "strong", description: "issue", evidence: "code", impact: "impact", memory: { id: "memory", version: 1, source: {} } }] };
