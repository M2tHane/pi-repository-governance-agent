...
import { withWorkspace } from "../../src/workspace/workspace.js";
import type { HealthJob } from "../../src/jobs/types.js";
...
async function healthApi() {
  const api = await import(new URL("../../src/health/health.service.js", import.meta.url).href).catch((error) => { if (error.code === "ERR_MODULE_NOT_FOUND") return {}; throw error; });
